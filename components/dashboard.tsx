      ...
      <section className="grid gap-8 grid-cols-1 md:grid-cols-3">
        ...
        <Card className="hover:shadow-md transition-all border-l-4 border-l-primary">
          ...
          <CardContent>
            ...
            <p className="text-sm text-muted-foreground mt-1">1 concluída este mês</p>
          </CardContent>
        </Card>
        ...
        <Card className="hover:shadow-md transition-all border-l-4 border-l-chart-2">
          ...
          <CardContent>
            <div className="text-3xl font-bold">2</div>
            <p className="text-sm text-muted-foreground mt-1">Próximo em 25/01/2024</p>
          </CardContent>
        </Card>

        <Card className="hover:shadow-md transition-all border-l-4 border-l-chart-3">
          <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-3">
        ...
        <Card className="shadow-sm">
          <CardHeader className="pb-4">
            <div className="flex items-center justify-between">
              <div>
                <CardTitle className="text-xl">Solicitações Recentes</CardTitle>
                <CardDescription className="mt-1.5">Acompanhe o status das suas solicitações</CardDescription>
              </div>
              <Button variant="ghost" size="sm" onClick={() => onNavigate("services")} className="gap-2">
                Ver todas
                ...
                >
                  <div className="flex items-center gap-4">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-muted-foreground">Protocolo: {request.id}</p>
                    </div>
                  </div>
                  <div className="text-right">
                    <Badge variant={getStatusVariant(request.status)} className="mb-1.5">
                      {request.status}
                    </Badge>
          ...
          <CardHeader className="pb-4">
            <div className="flex items-center justify-between">
              <div>
                ...
                <CardDescription className="mt-1.5">Seus compromissos agendados</CardDescription>
              </div>
              <Button variant="ghost" size="sm" onClick={() => onNavigate("appointments")} className="gap-2">
                Ver todos
                <ArrowRight className="h-4 w-4" />
              </Button>
            </div>
                ...
                >
                  <div className="flex items-center gap-4">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-muted-foreground">Código: {appointment.id}</p>
                    </div>
                  </div>
                  <div className="text-right">
